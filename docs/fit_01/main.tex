...
SCALE suite of codes \cite{scale}. The cross section for \gls{PWR} \gls{MOX} model was generated from modeling
a Westinghouse 17 by 17 LOPAR fuel assembly in TRITON for 27 burnup steps and the cross section for the \gls{SFR}
model was generated from COUPLE using a steady-state flux spectrum from $MC^2-3 / REBUS-3$ \cite{lee_mc2-3_2013}.
...
listed in tables \ref{fig:sfr_charge} and \ref{fig_sfr_discharge}, respectively.
...
and the balnket cross section (higher Pu+Am).
